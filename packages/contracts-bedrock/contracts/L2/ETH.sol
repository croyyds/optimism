 ...
 * @title ETH
 * @notice ETH is a legacy contract that held ETH balances before the Bedrock upgrade. All ETH
 *         balances held within this contract were migrated to the state trie as part of the
